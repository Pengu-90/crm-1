<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion text-white" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                <a class="nav-link mt-2" href="./main.php?page=dashboard">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="./main.php?page=orders_pending">Pending</a>
                        <a class="nav-link" href="./main.php?page=orders_process">Processing</a>
                        <a class="nav-link" href="./main.php?page=orders_process">Shipping</a>
                        <a class="nav-link" href="./main.php?page=orders_delivered">Delivered</a>
                    </nav>
                </div>
